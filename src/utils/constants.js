...
export const formAvatarEditElement = document.querySelector(
  ".avatar-popup__container"
);
export const formAddElement = document.querySelector(
  ".add-popup__container[name='add-photo']"
);
...
export const nameInput = document.querySelector(
  ".edit-popup__field[name='userName']"
);
export const jobInput = document.querySelector(
  ".edit-popup__field[name='userJob']"
);
...
export const token = "3b67ac11-b29e-4182-9110-a6f8ab5d8b17";
